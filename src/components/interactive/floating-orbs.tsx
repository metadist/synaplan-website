...
export function FloatingOrbs() {
  ...
  if (!allowHeavyEffects) {
    return (
      <div className="pointer-events-none absolute inset-0 overflow-hidden opacity-25">
        ...
        <div className="absolute -bottom-[180px] -left-[200px] h-[400px] w-[400px] rounded-full bg-soft-accent/45" />
      </div>
    );
  }
  ...
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden opacity-30">
      ...
      <div className="absolute -bottom-[180px] -left-[200px] h-[400px] w-[400px] animate-[float_26s_ease-in-out_infinite_reverse] rounded-full bg-soft-accent blur-[50px]" />
    </div>
  );
}
