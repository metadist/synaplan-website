...
import { FileText, CloudUpload, Database, Workflow, CalendarClock, Sparkles } from "lucide-react";

export const dynamic = "force-static";

const PATH = "/features/documents";
...
export async function generateMetadata({
  ...
  return {
    ...
    keywords:
      locale === "de"
        ? "KI Dokumente erstellen, KI Word Dokument, KI Excel, KI PowerPoint, Dokument in Nextcloud speichern, KI Berichte"
        : "AI document generation, AI Word document, AI Excel, AI PowerPoint, save document to Nextcloud, AI reports",
...
export default async function DocumentsFeaturePage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  const whyCards = [
    ...
    { icon: <CloudUpload className="size-5" />, title: t("why2Title"), desc: t("why2Desc") },
    { icon: <Database className="size-5" />, title: t("why3Title"), desc: t("why3Desc") },
    { icon: <Workflow className="size-5" />, title: t("why4Title"), desc: t("why4Desc") },
    { icon: <CalendarClock className="size-5" />, title: t("why5Title"), desc: t("why5Desc") },
    { icon: <Sparkles className="size-5" />, title: t("why6Title"), desc: t("why6Desc") },
  ];
